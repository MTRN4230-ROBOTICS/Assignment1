function TAU = irb120_p_controller2(robot, T, Q, QD, varargin)
...
desired_q = DesireQ; % Move all joints to position 0.5 rads.
desired_qd = DesireQD; % Make joints stationary at above position.
error_q = desired_q - Q;
error_qd = desired_qd - QD;

% controller
% Adjust the proportional constant independentlyfor each axis and design your own controller.
% proportional gain
