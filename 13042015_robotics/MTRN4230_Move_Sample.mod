MODULE MTRN4230_Move_Sample 
   ...
   ! initialise variables 
    ...
    PROC main()
        ...
        jointMoveTo 0,0,0,0,-90,0, v300;
        
        WHILE loopCon = 1 DO
            
                !linearMove -1, 0,0, v100;
                
                current := CJointT();
                
                str1 := numToStr(current.robax.rax_1, 5);
                str2 := numToStr(current.robax.rax_2, 5);
                str3 := numToStr(current.robax.rax_3, 5);
                str4 := numToStr(current.robax.rax_4, 5);
                str5 := numToStr(current.robax.rax_5, 5);
                str6 := numToStr(current.robax.rax_6, 5);
                
                TPWrite " angle1 is " + str1 + " angle2 is " + str2 + " angle3 is " + str3;
                TPWrite " angle4 is " + str4 + " angle5 is " + str5 + " angle6 is " + str6;
